...
const Navbar: React.FC<NavbarProps> = ({}) => {
  return (
    <nav className='flex justify-between container px-5 py-6 mx-auto md:py-10 lg:px-32'>
      <div className='flex items-center'>
        <img
          src='/my_unsplash_logo.svg'
          className='hidden md:block mr-3 h-9'
        ...
        <div className='relative'>
          ...
          <input
            type='search'
            className='p-3 sm:pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500'
